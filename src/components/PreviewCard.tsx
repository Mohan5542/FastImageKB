...
export const PreviewCard: React.FC<PreviewCardProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-5 shadow-lg backdrop-blur-sm space-y-5">
      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-zinc-800/80 pb-4">
        ...
        {/* View Mode Pills */}
        <div className="flex items-center gap-1.5 rounded-lg bg-zinc-950 p-1 border border-zinc-800/80">
          <button
            type="button"
      ...
      {viewMode === 'side-by-side' ? (
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {/* ORIGINAL CARD */}
          <div className="space-y-2 rounded-xl border border-zinc-800/80 bg-zinc-950/70 p-3.5">
            <div className="flex items-center justify-between text-xs">
              <span className="font-semibold text-zinc-300">Original Image</span>
              <span className="font-mono text-zinc-400">{originalSizeFormatted}</span>
            </div>
            ...
            <div className="flex items-center justify-between text-[11px] text-zinc-400 pt-1">
              ...
              <span className="uppercase">{item.originalMimeType.replace('image/', '')}</span>
            </div>
          </div>

          {/* OPTIMIZED CARD */}
          <div className="space-y-2 rounded-xl border border-blue-500/30 bg-zinc-950/70 p-3.5 shadow-sm">
            <div className="flex items-center justify-between text-xs">
            ...
            <div className="relative flex aspect-video w-full items-center justify-center overflow-hidden rounded-lg bg-checkerboard border border-zinc-900">
              {res ? (
                ...
                <div className="flex flex-col items-center justify-center text-xs text-zinc-400">
                  <Sparkles className="h-6 w-6 text-blue-500/40 animate-spin mb-2" />
        ...
        <div className="space-y-2">
          <div className="flex justify-between text-xs text-zinc-400 px-1">
            ...
            <span className="font-medium text-blue-400">Drag divider to compare quality</span>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 pt-2">
        ...
        <button
          ...
          className="flex flex-1 w-full items-center justify-center gap-2 rounded-xl bg-blue-600 px-6 py-3.5 text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition-all duration-200 hover:bg-blue-500 hover:shadow-blue-500/30 active:scale-[0.99] disabled:cursor-not-allowed disabled:opacity-50"
          id="btn-download-primary"
        >
          <Download className="h-4 w-4" />
          <span>Download Compressed Image ({compressedSizeFormatted})</span>
        </button>
        ...
        <div className="flex w-full sm:w-auto items-center gap-2">
          <button
            ...
            disabled={!res || isProcessing}
            className="flex flex-1 sm:flex-none items-center justify-center gap-1.5 rounded-xl border border-zinc-700/80 bg-zinc-800/80 px-4 py-3.5 text-xs font-medium text-zinc-200 transition-colors hover:border-zinc-600 hover:bg-zinc-700 hover:text-white disabled:opacity-50"
