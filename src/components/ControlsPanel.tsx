...
export const ControlsPanel: React.FC<ControlsPanelProps> = ({
  ...
  return (
    <div className="rounded-2xl border border-zinc-800/80 bg-zinc-900/60 p-5 shadow-lg backdrop-blur-sm space-y-6">
      {/* Panel Header */}
      <div className="flex items-center justify-between border-b border-zinc-800/80 pb-4">
        ...
        {totalImagesCount > 1 && onApplyBatchToAll && (
          <button
            ...
            className="flex items-center gap-1.5 rounded-lg border border-blue-500/30 bg-blue-500/10 px-2.5 py-1 text-xs font-medium text-blue-300 transition-colors hover:bg-blue-500/20"
            id="btn-apply-all"
      ...
      <div className="space-y-3">
        ...
        {/* Tab switch */}
        <div className="grid grid-cols-2 gap-1.5 rounded-xl bg-zinc-950 p-1 border border-zinc-800/80">
          <button
            type="button"
        ...
        {settings.mode === 'target-kb' ? (
          <div className="space-y-3 pt-1">
            <div className="flex items-center justify-between">
              <span className="text-xs text-zinc-400">Quick-Select Target:</span>
              <span className="font-mono text-xs font-semibold text-blue-400">
                Target: {settings.targetKB} KB
              </span>
            </div>
            ...
            <div className="grid grid-cols-3 gap-2 sm:grid-cols-6">
              {PRESET_KB_LIST.map((kb) => {
                const isSelected = settings.targetKB === kb;
                return (
                  <button
                    key={kb}
                    type="button"
                    onClick={() => handlePresetKBClick(kb)}
            ...
            <div className="flex items-center gap-2 pt-1">
              <label htmlFor="custom-target-kb" className="text-xs text-zinc-400 whitespace-nowrap">
                Custom Size:
              </label>
          ...
          {[
            ...
            return (
              ...
              >
                ...
                <span className="text-[10px] opacity-70">{fmt.badge}</span>
              </button>
            );
          })}
        </div>
      ...
      <div className="space-y-3 border-t border-zinc-800/80 pt-4">
        ...
        <div className="flex items-center gap-1.5 pt-1">
          <span className="text-[11px] text-zinc-400 mr-1">Scale:</span>
          ...
          <button
            ...
            className="rounded-md border border-zinc-800 bg-zinc-950 p-1 text-zinc-400 hover:border-zinc-700 hover:text-zinc-200"
        ...
        <div className="space-y-1.5 pt-1">
          <span className="text-[11px] text-zinc-400">Common Presets:</span>
          <div className="grid grid-cols-2 gap-1.5 sm:grid-cols-3">
            {[
              ...
              <button
                ...
                className="flex items-center justify-between rounded-lg border border-zinc-800/80 bg-zinc-950/70 px-2 py-1 text-[10px] text-zinc-300 hover:border-zinc-700 hover:bg-zinc-800/80"
